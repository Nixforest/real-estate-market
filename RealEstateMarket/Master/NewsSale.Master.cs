...
{
    public partial class NewsSale : System.Web.UI.MasterPage
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            listMenu.Add(new MenuItem("Home", "", "", "~/Default.aspx"));
            ...
            listMenu.Add(new MenuItem("Dự án", "", "", "~/Pages/Project/Project.aspx"));
