<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MoreNewsPageRead.ascx.cs" Inherits="RealEstateMarket.CustomControl.MoreNewsPageRead" %>
<style type="text/css">
    li a
    {
        color:Black;
...
<asp:ObjectDataSource ID="MoreNewsDataSource" runat="server" 
    ...
    <SelectParameters>
        <asp:QueryStringParameter Name="oldID" QueryStringField="id" Type="Int32" />
        <asp:Parameter DefaultValue="0" Name="from" Type="Int32" />
        <asp:Parameter DefaultValue="10" Name="number" Type="Int32" />
        <asp:QueryStringParameter DefaultValue="" Name="typeID" QueryStringField="cid" 
            Type="Int32" />
    </SelectParameters>
