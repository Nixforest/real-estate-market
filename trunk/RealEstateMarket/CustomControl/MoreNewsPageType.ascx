<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MoreNewsPageType.ascx.cs" Inherits="RealEstateMarket.CustomControl.MoreNewsPageType" %>
<style type="text/css">
    li a
    {
        color:Black;
...
<asp:ObjectDataSource ID="MoreNewsDataSource" runat="server" 
    ...
    <SelectParameters>
        ...
        <asp:QueryStringParameter DefaultValue="" Name="typeID" QueryStringField="id" 
            Type="Int32" />
    </SelectParameters>
